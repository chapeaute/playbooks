...
- Therefore you should provide a login_user and login_password. If you don't provide it, the module will connect with the
...
- cassandra_user: login_user=cassandra login_password=cassandra user=testuser password=testpassword

# Create a user 'testuser' with password 'testpassword' and superuser rights:
- cassandra_user: login_user=cassandra login_password=cassandra user=testuser password=testpassword superuser=yes

# Remove an existing user 'testuser' from the database
- cassandra_user: login_user=cassandra login_password=cassandra user=testuser state=absent
...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            protocol_version=dict(default=5),
